...
class Partnership extends Model
{
    ...
    {
        return [
            '_pid' => 'required|string|unique:partnerships',
            'category_id' => 'required|integer',
            'name' => 'required|string',
            'slug' => 'nullable|string|unique:partnerships',
    ...
    {
        return [
            '_pid' => 'nullable|string|' . Rule::unique('partnerships', '_pid')->ignore($id),
            'category_id' => 'required|integer',
            'name' => 'required|string',
            'slug' => 'nullable|string|' . Rule::unique('partnerships', 'slug')->ignore($id),
            'description' => 'nullable|string',
            'telephone' => 'nullable|string',
            'email' => 'nullable|email',
            'logo' => 'nullable|string',
